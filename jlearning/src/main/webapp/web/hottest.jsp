				...
				<div>
					...
					<ul class="nav nav-tabs content-toptab" role="tablist">
						<li role="presentation">
							<a href="../questions/showQuestions.do" aria-controls="home" role="tab" >新鲜事</a>
						</li>
						<li role="presentation"  class="active">
							<a href="../questions/hottest.do" aria-controls="profile" role="tab" >热门</a>
						</li>
						<li role="presentation">
				...
				<ul class="pagination">
					<li><c:if test="${curentPage-1==0}">
						<a  aria-label="Previous">
							...
							<a href="../questions/hottest.do?page=${curentPage-1}"
